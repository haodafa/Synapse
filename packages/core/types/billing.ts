// Mirrors the synapse-cloud Billing module response shapes
// (synapse-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — synapse-api itself does
