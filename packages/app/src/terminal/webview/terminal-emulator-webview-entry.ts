...
import type { TerminalInputModeState } from "@synapse/protocol/terminal-input-mode";
...
declare global {
  interface Window {
    ...
    __SYNAPSE_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __SYNAPSE_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--synapse-terminal-background";
...
window.__SYNAPSE_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__SYNAPSE_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
