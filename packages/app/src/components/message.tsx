...
import type { ToolCallDetail } from "@synapse/protocol/agent-types";
...
import type { AgentCapabilityFlags } from "@synapse/protocol/agent-types";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "synapse-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "synapse-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--synapse-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--synapse-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return {
    ...
    "--synapse-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--synapse-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  };
}
