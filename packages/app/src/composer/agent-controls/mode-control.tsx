...
import type { AgentMode, AgentProvider } from "@synapse/protocol/agent-types";
import { getModeVisuals, type AgentProviderDefinition } from "@synapse/protocol/provider-manifest";
