...
} from "@synapse/protocol/terminal-stream-protocol";
  ...
  mock.triggerMessage(
    wrapSessionMessage({
      ...
      payload: {
        ...
        detail: {
          type: "worktree_setup",
          worktreePath: "/tmp/project/.synapse/worktrees/feature-a",
          ...
          commands: [
            {
              index: 1,
              command: "npm install",
              cwd: "/tmp/project/.synapse/worktrees/feature-a",
              log: "phase-one\n",
              status: "running",
              exitCode: null,
            },
    ...
    attachments: [
      {
        ...
        url: "https://github.com/haodafa/Synapse/pull/123",
        baseRefName: "main",
  ...
  mock.triggerMessage(
    JSON.stringify({
      ...
      message: {
        ...
        payload: {
          directories: ["/Users/test/projects/synapse"],
