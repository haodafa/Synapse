 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "synapse-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "synapse-static.copilothub.ai")
 */
