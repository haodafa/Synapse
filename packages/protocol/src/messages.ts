...
import { MAX_EXPLICIT_AGENT_TITLE_CHARS } from "@synapse/protocol/agent-title-limits";
import { AgentProviderSchema } from "@synapse/protocol/provider-manifest";
...
} from "@synapse/protocol/schedule/rpc-schemas";
import {
...
} from "@synapse/protocol/loop/rpc-schemas";
import {
  SynapseConfigRawSchema,
  SynapseLifecycleCommandRawSchema,
  SynapseMetadataGenerationEntrySchema,
  SynapseMetadataGenerationSchema,
  ...
  type SynapseMetadataGeneration,
  type SynapseMetadataGenerationEntry,
  type SynapseScriptEntryRaw,
...
export const WriteProjectConfigRequestMessageSchema = z.object({
  ...
  requestId: z.string(),
  repoRoot: z.string(),
  config: SynapseConfigRawSchema,
  expectedRevision: SynapseConfigRevisionSchema.nullable(),
});
...
export const ReadProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      repoRoot: z.string(),
      ok: z.literal(true),
      config: SynapseConfigRawSchema.nullable(),
      revision: SynapseConfigRevisionSchema.nullable(),
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
...
export const WriteProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      ok: z.literal(true),
      config: SynapseConfigRawSchema,
      revision: SynapseConfigRevisionSchema,
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
