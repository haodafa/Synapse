...
import { WorkspaceSlugProvider, paths } from "@synapse/core/paths";
import { workspaceBySlugOptions } from "@synapse/core/workspace";
import { setCurrentWorkspace } from "@synapse/core/platform";
import { useAuthStore } from "@synapse/core/auth";
import { NoAccessPage } from "@synapse/views/workspace/no-access-page";
import { WelcomeAfterOnboarding } from "@synapse/views/workspace/welcome-after-onboarding";
import { SynapseIcon } from "@synapse/ui/components/common/synapse-icon";
import { useWorkspaceSeen } from "@synapse/views/workspace/use-workspace-seen";
...
export default function WorkspaceLayout({
  ...
  const loadingIndicator = (
    <div className="flex h-svh items-center justify-center">
      <SynapseIcon className="size-6 animate-pulse" />
    </div>
  );
