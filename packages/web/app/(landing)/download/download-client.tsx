...
import { captureDownloadPageViewed } from "@synapse/core/analytics";

const ALL_RELEASES_URL =
  "https://github.com/synapse-ai/synapse/releases";
  ...
  return (
    <>
      {/* Positioning context for the dark-variant LandingHeader —
          mirrors synapse-landing.tsx. The header is `absolute top-0
