...
export const metadata: Metadata = {
  title: "Download Synapse",
  description:
    "Download Synapse for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Synapse",
    description:
      "Get the Synapse desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
