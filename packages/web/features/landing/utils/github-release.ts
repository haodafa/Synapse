...
/**
 * Server-side fetcher for the latest Synapse release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/synapse-ai/synapse/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Synapse doesn't publish prereleases or drafts
