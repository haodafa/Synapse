...
const SAMPLE_LATEST_ASSET = {
  name: "synapse-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/synapse-ai/synapse/releases/download/v0.2.14/synapse-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "synapse-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/synapse-ai/synapse/releases/download/v0.2.13/synapse-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/synapse-ai/synapse/releases/tag/${overrides.tag}`,
