...
import { StatusIcon, PriorityIcon } from "@synapse/views/issues/components";
import { STATUS_CONFIG } from "@synapse/core/issues/config/status";
import { PRIORITY_CONFIG } from "@synapse/core/issues/config/priority";
import type { IssueStatus, IssuePriority } from "@synapse/core/types";
    ...
    <div className="relative aspect-video overflow-hidden rounded-lg border bg-background text-foreground shadow-2xl">
      ...
      <div className="flex h-10 shrink-0 items-center border-b bg-background px-4 text-sm">
        <div className="flex items-center gap-1.5 min-w-0 text-xs">
          <span className="text-muted-foreground">Synapse Demo</span>
...
const mockToolCalls = [
  ...
  { type: "tool_result" as const, preview: "ok  \tgithub.com/synapse/server/internal/handler\t0.847s" },
];
