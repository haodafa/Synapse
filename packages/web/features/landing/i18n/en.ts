...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    subheading:
      "Synapse is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "Synapse board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Synapse scans for 12 supported coding tools \u2014 Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run synapse setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 12 supported coding tools (Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
  ...
  openSource: {
    ...
    description:
      "Synapse is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Synapse on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Synapse support?",
        answer:
          "Synapse supports 12 coding tools out of the box: Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
        question: "Do I need to self-host, or is there a cloud version?",
        answer:
          "Both. You can self-host Synapse on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Synapse adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Synapse manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Synapse servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "We think the same inflection is happening again. For decades, software teams have been single-threaded \u2014 one engineer, one task, one context switch at a time. AI agents change that equation. Synapse brings time-sharing back, but for an era where the \u201cusers\u201d multiplexing the system are both humans and autonomous agents.",
      "In Synapse, agents are first-class teammates. They get assigned issues, report progress, raise blockers, and ship code \u2014 just like their human colleagues. The assignee picker, the activity timeline, the task lifecycle, and the runtime infrastructure are all built around this idea from day one.",
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Synapse.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Synapse shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Synapse for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Synapse for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Synapse to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Synapse tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New users now enter a guided welcome experience where Synapse Helper can introduce the workspace, give a tour, or build a slide-style welcome page",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Synapse",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Synapse issues, sync their status, and close the Synapse issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Synapse app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New `synapse daemon disk-usage` CLI surfaces per-task and per-workspace disk footprint",
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Synapse asterisk",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`synapse repo checkout --ref` targets a branch, tag, or specific commit when pulling a repo into the workspace",
          "`synapse agent avatar` uploads an agent avatar straight from the CLI",
        ...
        fixes: [
          ...
          "`synapse login --token <PAT>` accepts the PAT as a flag value instead of rejecting it",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Synapse Agent commits include a `Co-authored-by` trailer for proper Git attribution",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Backend default agent CLI args via `SYNAPSE_CLAUDE_ARGS` / `SYNAPSE_CODEX_ARGS` env vars",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`synapse agent create/update --custom-env KEY=VALUE` injects custom environment variables into agent runs",
          "Agent failure messages now include a tail of the runtime CLI's stderr — much easier to debug runtime errors",
          "CLI update download timeout is now configurable, so slow links no longer abort `synapse update`",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "`synapse update` self-update command — upgrade the CLI and local daemon without reinstalling",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Per-agent `model` field with a provider-aware dropdown — pick the LLM model for each agent from the UI or via `synapse agent create/update --model`, with live discovery from each runtime's CLI",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "One-click install & setup — `curl | bash` installs CLI, `--with-server` bootstraps full self-hosting, `synapse setup` configures your environment",
      ...
      },
      {
        ...
        changes: [
          ...
          "Daemon ensures synapse CLI is on PATH in agent task environment",
  ...
  contactSales: {
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Synapse?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Synapse or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Synapse for my team" },
      { value: "adopt_team", label: "Rolling out Synapse to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Synapse with existing tools" },
    ...
    consent: {
      intro:
        "Synapse, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Synapse, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Synapse.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Synapse, Inc. to store and process your information for the purpose of delivering the requested content.",
    ...
    success: {
      ...
      message:
        "A member of the Synapse team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
