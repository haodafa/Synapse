...
const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Synapse voice mode is now on.",
  "You are the Synapse voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Synapse voice mode is now off.",
  "Ignore any earlier Synapse voice mode instructions in this thread.",
].join(" ");
