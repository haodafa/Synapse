...
export type SynapseNodeEnv = "development" | "production" | "test";
...
export function resolveSynapseNodeEnv(env: NodeJS.ProcessEnv): SynapseNodeEnv | undefined {
  const value = env[SYNAPSE_NODE_ENV];
