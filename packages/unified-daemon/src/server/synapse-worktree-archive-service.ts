...
import { deleteSynapseWorktree, resolveSynapseWorktreeRootForCwd } from "../utils/worktree.js";
...
export async function archiveSynapseWorktree(
  dependencies: ArchiveSynapseWorktreeDependencies,
  options: {
    targetPath: string;
