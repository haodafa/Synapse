...
vi.mock("@synapse/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@synapse/core/github")>("@synapse/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Synapse will stop receiving webhooks/i)).toBeTruthy();
