...
import {
  ...
  useInboxUnreadCount,
} from "@synapse/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useMarkAllInboxRead,
...
} from "@synapse/core/inbox/mutations";
...
import type { InboxItem } from "@synapse/core/types";
import { Button } from "@synapse/ui/components/ui/button";
import {
  ResizablePanelGroup,
  ResizablePanel,
  ResizableHandle,
} from "@synapse/ui/components/ui/resizable";
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      <IssueDetail
        ...
        layoutId="synapse_inbox_issue_detail_layout"
