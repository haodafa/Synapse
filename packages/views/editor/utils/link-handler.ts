...
import { isGlobalPath } from "@synapse/core/paths";
...
/**
 * Open a link — internal paths dispatch synapse:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("synapse:navigate", { detail: { path } }),
    );
  } else {
