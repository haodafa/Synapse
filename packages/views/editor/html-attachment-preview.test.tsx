...
// it from useWorkspaceSlug() on @synapse/core/paths — stub to return a
// fixed slug so the tests do not need a WorkspaceSlugProvider tree.
vi.mock("@synapse/core/paths", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@synapse/core/paths")>();
  return {
    ...actual,
