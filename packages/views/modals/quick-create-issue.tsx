...
import { DialogTitle } from "@synapse/ui/components/ui/dialog";
...
} from "@synapse/core/issues/stores/quick-create-store";
...
export function AgentCreatePanel({
  ...
  // bundled synapse CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
