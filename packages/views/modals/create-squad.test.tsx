...
import type { Agent, MemberWithUser, Squad } from "@synapse/core/types";
...
vi.mock("@synapse/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@synapse/ui/components/ui/label", () => ({
