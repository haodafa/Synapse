...
import type { GitHubPullRequest } from "@synapse/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@synapse/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@synapse/core/github/queries")>(
    "@synapse/core/github/queries",
  );
  return {
    ...actual,
