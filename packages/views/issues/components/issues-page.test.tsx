...
// Mock @synapse/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@synapse/core/issues/stores/view-store", () => ({
...
vi.mock("@synapse/core/issues/stores/view-store-context", () => ({
...
vi.mock("@synapse/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@synapse/core/issues/stores/selection-store", () => ({
...
vi.mock("@synapse/core/issues/stores/recent-issues-store", () => ({
