...
import { useChatStore, DRAFT_NEW_SESSION } from "@synapse/core/chat";
import { createLogger } from "@synapse/core/logger";
import { enterKey, formatShortcut, modKey } from "@synapse/core/platform";
import type { UploadResult } from "@synapse/core/hooks/use-file-upload";
...
export function ChatInput({
  ...
  const handleSend = () => {
    ...
    // session, not the message — the agent then can't `synapse attachment
