...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@synapse/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { useAutoScroll } from "@synapse/ui/hooks/use-auto-scroll";
import { isTaskMessageTaskId, taskMessagesOptions } from "@synapse/core/chat/queries";
import { Markdown } from "@synapse/views/common/markdown";
import { copyMarkdown } from "../../editor";
import { AttachmentList } from "../../issues/components/comment-card";
import type { AgentAvailability } from "@synapse/core/agents";
import type { ChatMessage, ChatPendingTask, TaskFailureReason } from "@synapse/core/types";
import type { ChatTimelineItem } from "@synapse/core/chat";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@synapse/core/types").Attachment[];
}) {
