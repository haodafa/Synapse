...
const EMPTY_DAILY: import("@synapse/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@synapse/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@synapse/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@synapse/core/types").DashboardRunTimeDaily[] = [];
