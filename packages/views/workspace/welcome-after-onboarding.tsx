...
import { paths, useCurrentWorkspace } from "@synapse/core/paths";
...
import type { Agent, CreateIssueRequest, Issue } from "@synapse/core/types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
 ...
 *     2. Find-or-create a "Synapse Helper" agent on the picked runtime
