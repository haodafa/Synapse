...
import { captureEvent } from "@synapse/core/analytics";
...
} from "@synapse/core/onboarding";
import { workspaceListOptions } from "@synapse/core/workspace/queries";
import type { AgentRuntime, Workspace } from "@synapse/core/types";
 ...
 *     signal and navigate. The welcome hook creates the Synapse Helper
