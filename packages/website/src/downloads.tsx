...
export function releaseBase(version: string) {
  return `https://github.com/getsynapse/synapse/releases/download/v${version}`;
}
...
export function downloadUrls(release: ReleaseAssetInfo) {
  ...
  return {
    macAppleSilicon: `${base}/Synapse-${version}-arm64.dmg`,
    macIntel: `${base}/Synapse-${version}-x64.dmg`,
    linuxAppImage: `${base}/Synapse-${version}-x86_64.AppImage`,
    linuxDeb: `${base}/Synapse-${version}-amd64.deb`,
    linuxRpm: `${base}/Synapse-${version}-x86_64.rpm`,
    windowsExeX64: `${base}/${windowsX64Asset ?? `Synapse-Setup-${version}.exe`}`,
    windowsExeArm64: windowsArm64Asset ? `${base}/${windowsArm64Asset}` : null,
    androidApk: `${base}/synapse-v${version}-android.apk`,
  };
}

export const appStoreUrl = "https://apps.apple.com/app/synapse-pocket-engineer/id6758887924";
export const playStoreUrl = "https://play.google.com/store/apps/details?id=sh.synapse";
export const webAppUrl = "https://app.synapse.sh";
