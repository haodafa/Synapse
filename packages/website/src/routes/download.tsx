...
export const Route = createFileRoute("/download")({
  head: () =>
    pageMeta(
      "Download Synapse for macOS, Windows, Linux, iOS, and Android",
      "Install Synapse on every platform. Native desktop apps for macOS, Windows, and Linux. Mobile apps for iOS and Android. Self-hosted, open source, free to download.",
      "/download",
    ),
  component: Download,
});
  ...
  return (
    <SiteShell>
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8 mb-6">
        ...
        <div className="divide-y divide-border">
          ...
          <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CodeBlock size="sm">brew install --cask synapse</CodeBlock>
          </div>
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Run the Synapse server anywhere, connect from any client
            </p>
          </div>
        ...
        <div className="divide-y divide-border">
          ...
          <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CodeBlock size="sm">nix run github:getsynapse/synapse</CodeBlock>
          </div>
        </div>
      </section>
      ...
      <p className="text-center text-xs text-muted-foreground mt-8">
        ...
        <a
          href="https://github.com/getsynapse/synapse/releases"
          target="_blank"
