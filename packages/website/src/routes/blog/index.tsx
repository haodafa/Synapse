...
export const Route = createFileRoute("/blog/")({
  ...
  head: () =>
    pageMeta(
      "Blog – Updates and announcements from the Synapse team",
      "Product updates, technical posts, and announcements from the Synapse team. Notes on building a self-hosted, multi-agent dev environment for your phone.",
      "/blog",
    ),
  component: BlogIndex,
});
