...
const (
	handlerTestEmail         = "handler-test@synapse.ai"
...
func TestMain(m *testing.M) {
	...
	if dbURL == "" {
		dbURL = "postgres://synapse:synapse@localhost:5432/synapse?sslmode=disable"
	}
...
func TestSendCode(t *testing.T) {
	w := httptest.NewRecorder()
	body := map[string]string{"email": "sendcode-test@synapse.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	...
	t.Cleanup(func() {
		testPool.Exec(context.Background(), `DELETE FROM verification_code WHERE email = $1`, "sendcode-test@synapse.ai")
	})
}
...
func TestSendCodeDbError(t *testing.T) {
	...
	w := httptest.NewRecorder()
	body := map[string]string{"email": "dberror-test@synapse.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	req := httptest.NewRequest("POST", "/auth/send-code", &buf)
	req.Header.Set("Content-Type", "application/json")
...
func TestSendCodeRateLimit(t *testing.T) {
	const email = "ratelimit-test@synapse.ai"
	t.Cleanup(func() {
...
func TestVerifyCode(t *testing.T) {
	const email = "verify-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsDevCodeUnlessExplicitlyConfigured(t *testing.T) {
	...
	const email = "dev-code-disabled-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeAcceptsConfiguredDevCodeOutsideProduction(t *testing.T) {
	...
	const email = "dev-code-enabled-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsConfiguredDevCodeInProduction(t *testing.T) {
	...
	const email = "dev-code-production-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeWrongCode(t *testing.T) {
	...
	const email = "wrong-code-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeBruteForceProtection(t *testing.T) {
	...
	const email = "bruteforce-test@synapse.ai"
	ctx := context.Background()
...
func TestVerifyCodeNewUserHasNoWorkspace(t *testing.T) {
	const email = "workspace-verify-test@synapse.ai"
	ctx := context.Background()
