...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@synapse.ai", "ada@synapse.ai", true},
		{"uppercase normalized", "Ada@Synapse.AI", "ada@synapse.ai", true},
		{"trim whitespace", "  ada@synapse.ai  ", "ada@synapse.ai", true},
		{"display name stripped", "Ada Lovelace <ada@synapse.ai>", "ada@synapse.ai", true},
		{"angle-bracketed", "<ada@synapse.ai>", "ada@synapse.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@synapse.ai", "", false},
