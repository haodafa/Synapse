...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.synapse.ai"
	cookieDomain string // cookie scope, e.g. ".synapse.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.synapse.ai")
//   - COOKIE_DOMAIN           (e.g. ".synapse.ai")
