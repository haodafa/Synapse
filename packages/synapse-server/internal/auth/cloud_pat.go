...
// (Synapse Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Synapse Cloud Fleet service rather than by hitting our
...
// SYNAPSE_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.synapse.cloud). Trailing slashes are trimmed.
