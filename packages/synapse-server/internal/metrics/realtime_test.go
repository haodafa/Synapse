...
func TestRealtimeCollectorExposesCounters(t *testing.T) {
	...
	for _, want := range []string{
		"synapse_realtime_active_connections 3",
		"synapse_realtime_messages_sent_total 11",
		"synapse_realtime_redis_connected 1",
		`synapse_realtime_redis_mirror_errors_total{target="primary"} 2`,
		`synapse_realtime_redis_mirror_errors_total{target="secondary"} 5`,
	} {
