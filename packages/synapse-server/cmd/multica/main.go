...
var rootCmd = &cobra.Command{
	Use:   "synapse",
	Short: "Synapse CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with Synapse from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.PersistentFlags().String("server-url", "", "Synapse server URL (env: SYNAPSE_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: SYNAPSE_WORKSPACE_ID)")
