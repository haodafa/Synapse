...
Synapse 是一个融合了 Paseo 和 Multica 优秀特性的 AI 开发操作系统。它将 Paseo 的跨设备控制能力与 Multica 的团队协作功能完美结合，为开发团队提供了一个强大、统一的工作平台。
...
multica.issue:update   # 更新 Issue
multica.issue:assign   # 分配 Issue
multica.run:start      # 启动执行
multica.autopilot:trigger # 触发 Autopilot
```
