...
// Used by nix/package.nix's installPhase to materialize $out/lib/synapse
...
// installPhase copies each path to $out/lib/synapse/<path>, preserving the
